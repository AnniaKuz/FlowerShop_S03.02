...
TxtFile/MySQL/MongoDB work in an independent manner and do not share any information.
TxtFile is generated by program, but it is needed to create schemes in DBs before (MySQL and MongoDB codes are included)
You can use the program as many times as need, rewrite the data, save it, delete it, etc.
...
I implement serialization process at the end of the program. I have methods to deserialize Products and Invoices
 ...
 I get from txt.file and DBs which I get every time I enter the program.
 */
...
public class Main {
    ...
    public static void doSerialization(){
        ...
        try{
            ...
            System.out.println("Serialization of products is done successfully");
        }catch(IllegalArgumentException e){

        }
        try{
            ser.serializeInvoices();
            System.out.println("Serialization of invoices is done successfully");
        }catch(IllegalArgumentException e){
